...
Znormalizowane współczynniki filtrów melowej bywają używane jako gotowy zestaw cech. Do uzyskania \shortcut{MFCC}
...
tylko współczynniki rzeczywiste. \shortcut{DCT} (\foreign{Discrete Cosine Transform}) liczy się zatem tak,
...
Ciekawe są ich następne kroki, gdyż trenują \shortcut{GMM} rozmiaru również 5297
i dopasowują mikstury w ten sposób, że dla $k$ mikstury estymują jej wektor średnich i macierz kowariancji (pełną)
do danych ważonych przynależnością do $k$ trójki fonemów wyznaczoną przez \shortcut{TDNN}.
...
Zaletą \shortcut{DNN} jest możliwość operowania na większych wektorach wektorach, dlatego na wejściu sieć otrzymuje
...
Pierwsza sieć, którą zaproponowali, to \shortcut{DNN} z lokalnie połączoną pierwszą warstwą i w pełni połączonymi
