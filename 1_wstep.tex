...
\shortcut{GMM} (\foreign{gaussian mixture model}) w obecnych systemach do rozpoznania
...
jest w ogóle warty uwagi i w jakich sytuacjach, oraz porównanie go z wybranymi systemami \foreign{baseline}.
...
\begin{itemize}
    ...
    \item \shortcut{AUR} (\foreign{Area Under Curve})
\end{itemize}
