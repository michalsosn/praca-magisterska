...
Stworzony model \shortcut{DNN-GMM} jest istotny, gdyż nie został bezpośrednio wzięty z innej pracy,
lecz jest w pewnym stopniu nowy. Jego skuteczność niestety cierpi z powodu tego, że \techname{DeepSpeech}
...
zamkniętego zbioru zdań jak \shortcut{GMM-UBM}. Ostatecznie wyniki są mało obiecujące
