...
\begin{table}[H]
    ...
    \begin{tabu}{l*{6}{r}}
        ...
        \\
        \shortcut{HMM-GMM} & 15.85\% & 92.73\% & - & - & 5.16\% & 98.32\%
        \\
...
\begin{figure}[H]
    ...
    \begin{minipage}{.5\textwidth}
        ...
        \caption{Wykres krzywej \shortcut{ROC} dla \shortcut{HMM-GMM}, pierwszego zadania \techname{RedDots} i weryfikacji mówcy}
        \label{fig:4_3_hmm_roc_speaker}
    \end{minipage}%
    \begin{minipage}{.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{images/4_3_hmm_roc_both}
        \caption{Wykres krzywej \shortcut{ROC} dla \shortcut{HMM-GMM}, pierwszego zadania \techname{RedDots} i jednoczesnejj weryfikacji mówcy i treści}
